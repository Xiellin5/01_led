...
#define I2C_MASTER_SDA_IO 30      /*!< gpio number for I2C master data  */
...
void MPU_IIC_Init();
esp_err_t MPU_Init(void);                                                    // 初始化MPU6050
...
esp_err_t MPU_Set_Fifo(mpu6050_handle_t sensor, uint8_t sens);
